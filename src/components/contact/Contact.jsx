...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "3/15 Kurukkalam Palayam, Salem",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "vijayalingamp3@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91-9150170017",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I'm a motivated CSE student eager to learn and work on exciting projects. Feel free to reach out for project collaborations or any opportunities.
              </p>
            </div>
